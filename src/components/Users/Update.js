...
// Set initial form state values
    ...
    useEffect(() => {
      // Fetch user informations from db
        const fetchUser = async () => {
          try {
            ...
            // Set form data with fetch response values to show current values
            setFormData(
              {
                image: {
      ...
      const userUpdateSubmitHandler = async event => {
        ...
        // Update user in the db with new input values
        try {
      ...
      return (
        <React.Fragment>
          ...
          {!isLoading && loadedUser && ( 
            <form className="form-update-user" onSubmit={userUpdateSubmitHandler}>
              ...
              <Input
                ...
                element="input"
                type="select"
                label="Activate user status"
                validators={[VALIDATOR_REQUIRE()]}
                errorText="Change activated status to true / false"
                onInput={inputHandler}
                initialValue={loadedUser.activate}
                initialValid={true}
              />
